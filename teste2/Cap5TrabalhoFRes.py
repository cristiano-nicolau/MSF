...
vk = (140 * 1000)/3600      #Velocidade inicial em km/h

vt = 100/3.6                     #Neste caso pois a velocidade terminal é igual á velocidade inicial
...
for i in range(N-1):
    ...
    if (t[i]<0.905 and t[i+1]>0.905):                       #Encontrar o trabalho no instante t=0.4s
